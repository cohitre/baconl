var baconl = (function() {
    ...
    function nodeToHTML( node ) {
        ...
        var element = parseDefinition( node.definition );
        ...
        result += map( node.childNodes , function(index , childNode ){
            return nodeToHTML( childNode );
        } ).join("\n");
    ...
    var self = function( template ) {
        var tree = baconize( template.split("\n") );
